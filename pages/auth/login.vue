...
<template>
   <div class="bg-card p-4 sm:p-8 border border-border rounded max-w-[450px] mx-auto w-full mt-3">
      <h4 class="text-xl mb-2 font-bold text-center">Tizimga kirish</h4>
      <p class="font-medium mb-5 text-center">Kirish uchun foydalanuvchi va parolni kiriting.</p>
               ...
               <div class="flex flex-col space-y-2">
                  ...
                  <Dialog>
                     <DialogTrigger as-child>
                        <Button variant="link" class="text-primary justify-start px-0"> Parolni unitdingizmi? </Button>
                     </DialogTrigger>
                     <DialogContent>
                        <DialogHeader>
