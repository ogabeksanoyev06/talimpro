import { _ as _sfc_main$9 } from './index--b-3J809.mjs';
import { _ as __nuxt_component_0 } from './nuxt-link-Dhb71uaa.mjs';
import { ref, resolveComponent, mergeProps, withCtx, unref, createTextVNode, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, createCommentVNode, withModifiers, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate } from 'vue/server-renderer';
import { s as storeToRefs } from './server.mjs';
import { _ as _sfc_main$8 } from './Input-DvOO0onJ.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-card p-4 sm:p-8 border border-border rounded max-w-[560px] mx-auto w-full mt-3" }, _attrs))}><h4 class="text-xl mb-2 font-bold text-center">Ro&#39;yxatdan o&#39;tish</h4><p class="font-medium mb-10 text-center">Ro&#39;yxatdan o&#39;tish uchun quyidagilarni kiriting.</p>`);
      _push(ssrRenderComponent(_component_VForm, null, {
        default: withCtx(({ handleSubmit }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<form${_scopeId}><div class="flex flex-col gap-4"${_scopeId}><div class="grid grid-cols-1 md:grid-cols-2 gap-4"${_scopeId}><div class="flex flex-col space-y-2"${_scopeId}>`);
                    ...
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(_sfc_main$6), {
                          placeholder: selectedUserType.value ? selectedUserType.value.name : "Foydalanuvchi turi"
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$3), null, {
                          default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(`<!--[-->`);
                              ssrRenderList(usertype.value, (item) => {
                              ...
                              return [
                                ...
                                (openBlock(true), createBlock(Fragment, null, renderList(usertype.value, (item) => {
            ...
            _push2(ssrRenderComponent(_component_VField, {
              ...
              "onUpdate:modelValue": ($event) => user.value.username = $event
            }, {
            ...
            _push2(`</div></div><div class="grid grid-cols-1 md:grid-cols-2 gap-4"${_scopeId}><div class="flex flex-col space-y-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_VField, {
              name: "firstName",
              rules: "required|max:60|min:3",
            ...
            _push2(`</div></div><div class="flex flex-col space-y-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_VField, {
              name: "phone",
            ...
            _push2(`</div><div class="grid grid-cols-1 md:grid-cols-2 gap-4"${_scopeId}><div class="flex flex-col space-y-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_VField, {
              name: "password",
              rules: "required|passwordformat|max:8|min:8",
              modelValue: user.value.password,
              "onUpdate:modelValue": ($event) => user.value.password = $event
            }, {
              default: withCtx(({ errors }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_VField, {
              ...
              modelValue: user.value.passwordConfirmation,
              "onUpdate:modelValue": ($event) => user.value.passwordConfirmation = $event
            }, {
              default: withCtx(({ errors }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$8), {
                    ...
                    type: passwordConfirmationField.value ? "password" : "text",
                  ...
                  return [
                    ...
                    createVNode("div", { class: "relative" }, [
                      ...
                      createVNode("span", { class: "absolute top-1/2 -translate-y-1/2 end-0 flex items-center justify-center px-3 cursor-pointer" }, [
                        !passwordConfirmationField.value ? (openBlock(), createBlock("svg", {
                          key: 0,
                          width: "14",
                          height: "14",
                          viewBox: "0 0 14 14",
...
//# sourceMappingURL=register-DG3aHNWd.mjs.map
