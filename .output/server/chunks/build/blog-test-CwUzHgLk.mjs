  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(testResultId), (item, i) => {
        var _a;
        _push(`<div class="flex flex-col space-y-6"><div class="inline-flex justify-center w-full"><p class="text-[18px] text-center shadow-[0_0px_10px_rgba(0,0,0,.15)] font-bold py-3 px-6">${ssrInterpolate(selectedQuestion.value.science)}</p></div><div class="border">`);
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(_component_TableCell, { class: "p-4 font-medium" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<span${_scopeId4}>Blog test</span>`);
                              } else {
                                return [
                                  createVNode("span", null, "Blog test")
                                ];
                              }
                            }),
                            _: 2
                          ...
                          _push4(ssrRenderComponent(_component_TableCell, null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              var _a2, _b, _c, _d;
                              if (_push5) {
                                _push5(`<span${_scopeId4}>${ssrInterpolate((_b = (_a2 = unref(testResultId)[0]) == null ? void 0 : _a2.blogs) == null ? void 0 : _b.science)}</span>`);
                              } else {
                                return [
                                  createVNode("span", null, toDisplayString((_d = (_c = unref(testResultId)[0]) == null ? void 0 : _c.blogs) == null ? void 0 : _d.science), 1)
                                ];
                              }
                            }),
                            _: 2
                          ...
                          _push4(ssrRenderComponent(_component_TableCell, { class: "p-4" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              var _a2, _b, _c, _d;
                              if (_push5) {
                                _push5(`<span${_scopeId4}>${ssrInterpolate((_b = (_a2 = unref(testResultId)[0]) == null ? void 0 : _a2.blogs) == null ? void 0 : _b.question_count)}</span>`);
                              } else {
                                return [
                                  createVNode("span", null, toDisplayString((_d = (_c = unref(testResultId)[0]) == null ? void 0 : _c.blogs) == null ? void 0 : _d.question_count), 1)
                                ];
                              }
                            }),
                            _: 2
                          ...
                          _push4(ssrRenderComponent(_component_TableCell, { class: "p-4" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              var _a2, _b, _c, _d;
                              if (_push5) {
                                _push5(`<span${_scopeId4}>${ssrInterpolate((_b = (_a2 = unref(testResultId)[0]) == null ? void 0 : _a2.blogs) == null ? void 0 : _b.max_ball)}</span>`);
                              } else {
                                return [
                                  createVNode("span", null, toDisplayString((_d = (_c = unref(testResultId)[0]) == null ? void 0 : _c.blogs) == null ? void 0 : _d.max_ball), 1)
                                ];
                              }
                            }),
                            _: 2
                          ...
                          return [
                            ...
                            createVNode(_component_TableCell, null, {
                              default: withCtx(() => {
                                var _a2, _b;
                                return [
                                  createVNode("span", null, toDisplayString((_b = (_a2 = unref(testResultId)[0]) == null ? void 0 : _a2.blogs) == null ? void 0 : _b.science), 1)
                                ];
                              }),
                              _: 1
                            }),
                            createVNode(_component_TableCell, { class: "p-4" }, {
                              default: withCtx(() => {
                                var _a2, _b;
                                return [
                                  createVNode("span", null, toDisplayString((_b = (_a2 = unref(testResultId)[0]) == null ? void 0 : _a2.blogs) == null ? void 0 : _b.question_count), 1)
                                ];
                              }),
                              _: 1
                            }),
                            createVNode(_component_TableCell, { class: "p-4" }, {
                              default: withCtx(() => {
                                var _a2, _b;
                                return [
                                  createVNode("span", null, toDisplayString((_b = (_a2 = unref(testResultId)[0]) == null ? void 0 : _a2.blogs) == null ? void 0 : _b.max_ball), 1)
                                ];
                              }),
                              _: 1
                            }),
        ...
        _push(`</div><div class="flex flex-col gap-3"><div class="${ssrRenderClass([{
          "border-green-500": selectedQuestion.value.is_correct && selectedQuestion.value.is_picked,
          "border-destructive": selectedQuestion.value.is_picked && !selectedQuestion.value.is_correct,
          "border-secondary": !(selectedQuestion.value.is_correct && selectedQuestion.value.is_picked) && !(selectedQuestion.value.is_picked && !selectedQuestion.value.is_correct)
        }, "flex flex-col gap-2 border-2 p-4"])}"><div class="question flex items-start text-base"><b id="question_number" class="mr-1">${ssrInterpolate(unref(testNumber) + 1)}. </b><span class="flex flex-wrap">${(_a = selectedQuestion.value.question) != null ? _a : ""}</span></div><div>`);
        if (selectedQuestion.value.is_correct && selectedQuestion.value.is_picked) {
          _push(`<span class="!text-green-500">(To&#39;g&#39;ri)</span>`);
        } else {
          _push(`<!---->`);
        }
        if (selectedQuestion.value.is_picked && !selectedQuestion.value.is_correct) {
          _push(`<span class="text-destructive">(Xato)</span>`);
        } else {
          _push(`<!---->`);
        }
        if (!selectedQuestion.value.is_picked) {
        ...
        ssrRenderList(selectedQuestion.value.answers, (answer, aIndex) => {
          _push(`<li class="${ssrRenderClass([{
            "border-green-500 text-green-500": selectedQuestion.value.is_correct && selectedQuestion.value.is_picked && selectedQuestion.value.answer === aIndex + 1,
            "text-destructive border-destructive": !selectedQuestion.value.is_correct && selectedQuestion.value.is_picked && selectedQuestion.value.answer === aIndex + 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/results/blog-test.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=blog-test-CwUzHgLk.mjs.map
