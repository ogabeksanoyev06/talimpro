...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/png","href":"/gerb.png"}],"style":[],"script":[],"noscript":[],"title":"Bilimdon uchun havola - Ta‘limPro"};
